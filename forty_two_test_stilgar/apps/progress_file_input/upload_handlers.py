"""Upload handler for ProgressFileInput. Records current progress to cache.
Closly based on http://djangosnippets.org/snippets/678/"""
...
class UploadProgressCachedHandler(FileUploadHandler):
    ...
    def upload_complete(self):
        cache.set(self.cache_key, {'state': 'done'})
        #if self.cache_key:
